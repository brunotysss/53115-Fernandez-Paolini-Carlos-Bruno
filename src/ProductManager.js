...
const idNumber = Number(id);
   ...
   // console.log("Productos:", productos); // Array de objetos
  //  console.log(typeof productos); // "object"
  
    const productoEncontrado = productos.find(producto => producto.id === idNumber);
   // console.log("Producto encontrado:", productoEncontrado); // Registrar el producto encontrado o null
